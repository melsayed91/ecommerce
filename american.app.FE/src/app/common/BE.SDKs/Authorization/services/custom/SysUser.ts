...
/**
 * Api services for the `SysUser` model.
 */
@Injectable()
export class SysUserApi extends BaseLoopBackApi {
  ...
  public countAccessTokens(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/sysUsers/:id/accessTokens/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   *  - `greeting` – `{string}` - 
   */
  public greet(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/sysUsers/greet";
    let _routeParams: any = {};
  ...
  /**
   * @ngdoc method
   * @name sdk.SysUser#getCurrent
   * @methodOf sdk.SysUser
   *
   * @description
   *
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/sysUsers" + "/:id";
   ...
   * call to {@link sdk.SysUser#login} or
   * {@link sdk.SysUser#getCurrent}. Return null when there
   ...
   * call to {@link sdk.SysUser#login}
   *
  ...
  /**
   * @name sdk.SysUser#isAuthenticated
   *
