...
export class RfqApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `Rfq` object.)
   * </em>
   */
   ...
   * @param {any} id rfq id
   *
   * @param {any} fk Foreign key for offers
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdOffers(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/rfqs/:id/offers/:fk";
    let _routeParams: any = {
   ...
   */
  public destroyByIdOffers(id: any, fk: any, customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public updateByIdOffers(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public linkOffers(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/rfqs/:id/offers/rel/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
   ...
   * This method returns no data.
   */
  public unlinkOffers(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/rfqs/:id/offers/rel/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public existsOffers(id: any, fk: any, customHeaders?: Function): Observable<any> {
  ...
  /**
   * Add a related item by id for attachments.
   *
   * @param {any} id rfq id
   *
   * @param {any} fk Foreign key for attachments
   ...
   * </em>
   */
  public linkAttachments(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/rfqs/:id/attachments/rel/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Remove the attachments relation to an item by id.
   *
   * @param {any} id rfq id
   *
   * @param {any} fk Foreign key for attachments
   ...
   * This method returns no data.
   */
  public unlinkAttachments(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/rfqs/:id/attachments/rel/:fk";
    let _routeParams: any = {
  ...
  /**
   * Check the existence of attachments relation to an item by id.
   *
   * @param {any} id rfq id
   *
   * @param {any} fk Foreign key for attachments
   ...
   * </em>
   */
  public existsAttachments(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "HEAD";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/rfqs/:id/attachments/rel/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public getOffers(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/rfqs/:id/offers";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createOffers(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
   ...
   * This method returns no data.
   */
  public deleteOffers(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/rfqs/:id/offers";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countOffers(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/rfqs/:id/offers/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   *  - `rfq` – `{any}` - 
   */
  public updateRFQStatus(rfqId: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/rfqs/updaterfqstatus";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
   ...
   * </em>
   */
  public createManyOffers(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/rfqs/:id/offers";
    let _routeParams: any = {
