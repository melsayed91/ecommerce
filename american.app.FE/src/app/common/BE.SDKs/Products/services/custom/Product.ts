...
export class ProductApi extends BaseLoopBackApi {
   ...
   *  - `result` – `{any}` - 
   */
  public incrementProductSells(productId: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/products/incrementProductSells";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
   ...
   *  - `result` – `{any}` - 
   */
  public incrementProductViews(productId: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/products/incrementProductViews";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof productId !== 'undefined' && productId !== null) _urlParams.productId = productId;
   ...
   *  - `result` – `{any}` - 
   */
  public suggest(prefix: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/products/suggest";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof prefix !== 'undefined' && prefix !== null) _urlParams.prefix = prefix;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
   ...
   *  - `result` – `{any}` - 
   */
  public startSale(sale: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/products/sale/start";
    let _routeParams: any = {};
   ...
   *  - `result` – `{any}` - 
   */
  public stopSale(productId: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/products/sale/stop";
    let _routeParams: any = {};
