...
export class ProductApi extends BaseLoopBackApi {
  ...
  public linkAttachments(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/products/:id/attachments/rel/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Queries attachments of product.
   *
   * @param {any} id product id
   *
   * @param {object} filter 
   ...
   *  - `products` – `{any}` - 
   */
  public getUserProducts(accountId: any, categoryId: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
  ...
  public updateUserProduct(updateObj: any, customHeaders?: Function): Observable<any> {
    ...
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof updateObj !== 'undefined' && updateObj !== null) _urlParams.updateObj = updateObj;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
