...
export class MessageApi extends BaseLoopBackApi {
   ...
   *  - `message` – `{any}` - 
   */
  public addMessage(message: any, customHeaders?: Function): Observable<any> {
   ...
   *  - `messages` – `{any}` - 
   */
  public getMessages(conversationId: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   *  - `messages` – `{any}` - 
   */
  public markMessageAsSeen(messageId: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
