...
export class ProfileInfoComponent implements OnInit {
  ...
  saveProfile() {
    ...
    this.accountApi.updateAccountData(this.accountData.id, this.profileData).subscribe((response) => {
      this.accountApi.getAccountData(this.userAccount.accountDataId).subscribe((response) => {
