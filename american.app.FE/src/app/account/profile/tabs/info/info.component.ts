...
export class InfoComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.accountService.getAccountData(this.userAccount.accountDataId)
  ...
  saveProfile() {
    ...
    this.accountService.updateAccountData(toBeUpdated.accountDataId, toBeUpdated.updateQuery)
      .takeWhile(() => this.alive)
      .subscribe((response) => {
        this.accountService.getAccountData(this.userAccount.accountDataId)
          .takeWhile(() => this.alive)
